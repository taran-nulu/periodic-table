...
class PeriodicTable:
    def __init__(self):
        self.elements = [
            ...
            # Element("Helium", "He", 2, 4, Family.NOBLE_GAS, 1, 1),
            # Element("Magnesium", "Mg", 12, 24, Family.ALKALINE_EARTH_METAL, 2, 0),
            # Element("Rutherfordium", "Rf", 104, 261, Family.TRANSITION_METAL, 0, 2)
            ...
            Element("Lithium", "Li", 3, 6.94, Family.ALKALI_METAL, 1, 0),
            Element("Beryllium", "Be", 4, 9.01, Family.ALKALINE_EARTH_METAL, 1, 1),
            ...
            Element("Magnesium", "Mg", 12, 24.3, Family.ALKALINE_EARTH_METAL, 2, 1),
            ...
            Element("Calcium", "Ca", 20, 40.07, Family.ALKALINE_EARTH_METAL, 3, 1),
            Element("Scandium", "Sc", 21, 44.95, Family.TRANSITION_METAL, 3, 2),
            Element("Titanium", "Ti", 22, 47.86, Family.TRANSITION_METAL, 3, 3),
            Element("Vanadium", "V", 23, 50.94, Family.TRANSITION_METAL, 3, 4),
            Element("Chromium", "Cr", 24, 51.99, Family.TRANSITION_METAL, 3, 5),
            Element("Manganese", "Mn", 25, 54.93, Family.TRANSITION_METAL, 3, 6),
            ...
            Element("Strontium", "Sr", 38, 87.62, Family.ALKALINE_EARTH_METAL, 4, 1),
            Element("Yttrium", "Y", 39, 88.9, Family.TRANSITION_METAL, 4, 2),
            Element("Zirconium", "Zr", 40, 91.22, Family.TRANSITION_METAL, 4, 3),
            Element("Niobium", "Nb", 41, 92.9, Family.TRANSITION_METAL, 4, 4),
            Element("Molybdenum", "Mo", 42, 95.96, Family.TRANSITION_METAL, 4, 5),
            Element("Technetium", "Tc", 43, 98, Family.TRANSITION_METAL, 4, 6),
            Element("Ruthenium", "Ru", 44, 101.07, Family.TRANSITION_METAL, 4, 7),
            Element("Rhodium", "Rh", 45, 102.9, Family.TRANSITION_METAL, 4, 8),
            Element("Palladium", "Pd", 46, 106.42, Family.TRANSITION_METAL, 4, 9),
            Element("Silver", "Ag", 47, 107.86, Family.TRANSITION_METAL, 4, 10),
            Element("Cadmium", "Cd", 48, 112.41, Family.TRANSITION_METAL, 4, 11),
            ...
            Element("Barium", "Ba", 56, 137.32, Family.ALKALINE_EARTH_METAL, 5, 1),
            ...
            Element("Lutetium", "Lu", 71, 174.96, Family.TRANSITION_METAL, 8, 16),
            Element("Hafnium", "Hf", 72, 178.49, Family.TRANSITION_METAL, 5, 3),
            Element("Tantalum", "Ta", 73, 180.94, Family.TRANSITION_METAL, 5, 4),
            Element("Tungsten", "W", 74, 183.84, Family.TRANSITION_METAL, 5, 5),
            Element("Rhenium", "Re", 75, 186.2, Family.TRANSITION_METAL, 5, 6),
            Element("Osmium", "Os", 76, 190.23, Family.TRANSITION_METAL, 5, 7),
            Element("Iridium", "Ir", 77, 192.21, Family.TRANSITION_METAL, 5, 8),
            Element("Platinum", "Pt", 78, 195.08, Family.TRANSITION_METAL, 5, 9),
            Element("Gold", "Au", 79, 196.96, Family.TRANSITION_METAL, 5, 10),
            Element("Mercury", "Hg", 80, 200.59, Family.TRANSITION_METAL, 5, 11),
            ...
            Element("Radium", "Ra", 88, 226, Family.ALKALINE_EARTH_METAL, 6, 1),
            ...
            Element("Lawrencium", "Lr", 103, 262, Family.TRANSITION_METAL, 9, 16),
            Element("Rutherfordium", "Rf", 104, 267, Family.TRANSITION_METAL, 6, 3),
            Element("Dubnium", "Db", 105, 268, Family.TRANSITION_METAL, 6, 4),
            Element("Seaborgium", "Sg", 106, 271, Family.TRANSITION_METAL, 6, 5),
            Element("Bohrium", "Bh", 107, 272, Family.TRANSITION_METAL, 6, 6),
            Element("Hassium", "Hs", 108, 270, Family.TRANSITION_METAL, 6, 7),
            Element("Meitnerium", "Mt", 109, 276, Family.TRANSITION_METAL, 6, 8),
            Element("Darmstadtium", "Ds", 110, 281, Family.TRANSITION_METAL, 6, 9),
            Element("Roentgenium", "Rg", 111, 280, Family.TRANSITION_METAL, 6, 10),
            Element("Copernicium", "Cn", 112, 285, Family.TRANSITION_METAL, 6, 11),
            Element("Nihonium", "Uut", 113, 284, Family.METAL, 6, 12),
            Element("Flerovium", "Uuq", 114, 289, Family.METAL, 6, 13),
            Element("Moscovium", "Uup", 115, 288, Family.HALOGEN, 6, 14),
            Element("Livermorium", "Uuh", 116, 293, Family.NOBLE_GAS, 6, 15),
            Element("Tennessine", "Uus", 117, 294, Family.ALKALI_METAL, 6, 16),
            Element("Ognasson", "Uuo", 118, 294, Family.ALKALINE_EARTH_METAL, 6, 17),        
        ]
    ...
    def draw(self):
        ...
        canvas = Canvas(tk, width=1000, height=800, background="white", scrollregion=(0, 0, width, height))
